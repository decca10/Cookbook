...
try:
    ...
    if st.sidebar.button("Generate Markdown"):
        ...
        with open(os.path.join("/Volumes/homes/Melissa/Drive/SynologyDrive/Work/NLP projects/Cookbook",response.split('\n')[0]+".md"), "w") as file:
            file.write(response)


    # Save as a Markdown file
    file_name = response.split('\n')[0]
    path = "/Volumes/homes/Melissa/Drive/SynologyDrive/Work/NLP projects/Cookbook"
